...
import { Download, Laptop, Lock, ChevronRight, Info } from "lucide-react"
    ...
    <div className="min-h-screen  bg-[#fcf5eb]">
     ...
     <div className="p-6">
      ...
      <div className="flex flex-col items-center px-6 pb-6 space-y-6">
        ...
        >
          <CardContent className="flex items-center justify-between py-4 px-10">
            ...
            <Button
              className="bg-[#25d366] hover:bg-emerald-600 text-black py-6 px-4 rounded-full flex items-center"
              style={{ border: "1px solid black" }}
            >
              Download
        ...
        <Card className="w-full max-w-2xl border border-black shadow-sm py-8">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl font-medium text-gray-800">Enter code on phone</CardTitle>
            <p className="text-sm text-black mt-2">
              Linking WhatsApp account <span className="font-medium">+1 (332) 207-6524</span>{" "}
              <button className="text-emerald-600 font-bold hover:text-emerald-700 text-sm">(edit)</button>
            </p>
          </CardHeader>
          <CardContent className="space-y-6">
            {/* Verification Code Input */}
            <div className="flex justify-center bg-gray-100 py-4 rounded-xl">
              <div className="flex gap-2 items-center ">
                {/* First group of 4 letters */}
                <div className="flex gap-1">
                  {["K", "F", "C", "J"].map((letter, index) => (
                    <div
                      key={index}
                      className="w-12 h-12 border border-gray-300 rounded-lg flex items-center justify-center text-lg font-medium bg-gray-50"
                    >
                      {letter}
                    </div>
                  ))}
                ...
                {/* Dash separator */}
                <div className="text-gray-400 text-xl font-medium px-2">-</div>

                {/* Second group of 4 characters */}
                <div className="flex gap-1">
                  {["2", "B", "2", "2"].map((char, index) => (
                    <div
                      key={index}
                      className="w-12 h-12 border border-gray-300 rounded-lg flex items-center justify-center text-lg font-medium bg-gray-50"
                    >
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-start gap-4">
                <div className="w-6 h-6 rounded-full bg-gray-200 border border-black flex items-center justify-center text-sm font-medium text-gray-600 ">
                  1
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-gray-700">On Android tap Menu</span>
                  <Info className="w-4 h-4 text-gray-400" />
                  <span className="text-gray-700">· On iPhone tap Settings</span>
                  <Info className="w-4 h-4 text-gray-400" />
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <span className="text-gray-700">Tap Linked devices, then Link device</span>
              </div>
            ...
            <div className="flex  pt-4">
              <button className="text-gray-600 hover:text-gray-800 text-sm flex items-center gap-1 border-b-2 border-emerald-600 hover:border-emerald-700 cursor-pointer">
                Log in with QR code
