  ...
  return (
    <div className="min-h-screen  bg-[#fcf5eb]">
      ...
      <div className="flex flex-col items-center px-6 pb-6 space-y-6">
        ...
        <Card className="w-full max-w-2xl border border-black shadow-sm">
          <CardHeader className="text-center pb-4">
            <CardTitle className="text-2xl font-normal text-gray-800">Enter phone number</CardTitle>
            <p className="text-sm text-black mt-2">Select a country and enter your phone number.</p>
          </CardHeader>
          <CardContent className="space-y-6 px-48">
            {/* Country Selector */}
            <Select defaultValue="russia">
              <SelectTrigger className="w-full h-12 rounded-full border-black">
                <SelectValue>
                  <div className="flex items-center gap-2">
            ...
            <Input
              ...
              placeholder="+7"
              defaultValue="+7"
              className="w-full h-12 rounded-full border-black px-4 text-center"
            />

            {/* Next Button */}
            <Link href="/verify-code">
            <div className="flex justify-center pt-4 ">
              <Button className="bg-emerald-600 hover:bg-emerald-700 cursor-pointer text-white px-8 py-2 rounded-full">Next</Button>
            </div>
            </Link>
        ...
        <div className="text-center space-y-4">
          <p className="text-black">
            ...
            <button className="text-black border-b-2 border-emerald-600 hover:text-emerald-700 ">Get started</button>
          </p>
