  ...
  return (
    <div className="min-h-screen bg-[#fcf5eb]">
      ...
      <div className="flex flex-col items-center px-6 pb-6 space-y-6">
        ...
        {/* Login Steps & QR Code */}
        <Card className="border border-black shadow-sm w-full max-w-5xl py-8 px-10">
          <CardHeader>
            <CardTitle className="text-4xl font-normal text-gray-800">
              Steps to log in
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span
                      className="bg-[#f7f8fa] rounded"
                      style={{ border: "0.5px solid #d1d7db" }}
                    >
                      <svg
                        viewBox="0 0 24 24"
                        height="20"
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <button className="mt-4 text-emerald-600 underline underline-offset-2 cursor-pointer hover:text-emerald-700 text-sm flex items-center gap-1">
